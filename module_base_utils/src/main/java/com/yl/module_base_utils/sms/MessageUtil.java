package com.yl.module_base_utils.sms;
...
public class MessageUtil {
    ...
    public static List<MessageBean> getSmsInPhone(long lastPostTime) {
        ...
        try {
            ContentResolver cr = ModuleUtil.getContext().getContentResolver();
    ...
    private static String getPeopleNameFromPerson(String address) {
        ...
        Cursor cursor = ModuleUtil.getContext().getContentResolver().query(uri_Person, projection, null, null, null);
